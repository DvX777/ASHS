...
export const api = {
  ...
  radarrDownloaded:   () => req<any>("GET", "/radarr/downloaded"),
  radarrTriggerDiscovery: () => req<any>("POST", "/radarr/trigger-discovery"),
  radarrSyncLibrary:  () => req<any>("POST", "/radarr/sync-library"),
  radarrImportAshs:   () => req<any>("POST", "/radarr/import-ashs"),
  radarrCleanQueue:   () => req<any>("POST", "/radarr/clean-queue"),
